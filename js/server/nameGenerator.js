...
//depuis http://www.scrabble.org.au/words/fours.htm
...
function generateGenericName(syllables, separator)
{
	...
	if(lookupWord(firstName)) //if this word is known
	{	
		console.log('connu intercepté : '+firstName);
		return generateGenericName(syllables, separator); //try again, recursively.
	}
	else
		return firstName;
}
...
function lookupWord(word)
{
	...
	if(word.length == 4)
		for (var i = 0; i < letter_4w_en.length; i++)
		{
			if(letter_4w_en[i] === word)
				return true;
		}
